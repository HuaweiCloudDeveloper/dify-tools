...
| ----------------------- | -------- | ------------------------------------------------ | ---------------------------------- | ---- |
| huawei-cloud-obs  | 工具     | 提供dify工作流中操作华为云对象存储的基本操作工具 | [插件源码](tools/huawei-cloud-obs) | yuez |
| huawei-cloud-gaussdb | 工具     | 提供dify工作流中操作华为云GaussDB的基本操作工具 | [插件源码](tools/huawei-cloud-gaussdb) | yuez |
